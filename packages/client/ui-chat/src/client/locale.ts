...
export const zh = {
  ...
  'settings.markdown.title': 'Markdown 显示',
  'settings.markdown.description': '控制助手消息以渲染效果还是原文源码显示',
  'settings.markdown.render': '渲染',
  'settings.markdown.raw': '原文',
  ...
  'filePreview.binary': '二进制文件，无法在页面内预览',
  'filePreview.loading': '加载中…',
  'filePreview.error': '无法读取文件：{message}',
  'filePreview.loaded': '已加载 {loaded} / {total}',
  'filePreview.copy': '复制',
  'filePreview.copied': '已复制',
  'filePreview.jsonLabel': 'JSON 内容',
  'filePreview.truncated': '内容过长，仅显示前 20000 字符（共 {total} 字符）',
  'filePreview.imageFailed': '无法加载图片',
  ...
  'message.stopped': '已停止',
  'message.rawView': '查看 Markdown 原文',
  'message.renderView': '查看渲染效果',
...
export const en = {
  ...
  'stats.expand': 'Expand stats',
  'stats.collapse': 'Collapse stats',
  'stats.llm': 'LLM {duration}',
  ...
  'settings.transcript.normal': 'Normal',
  'settings.transcript.compact': 'Compact',
  'settings.markdown.title': 'Markdown display',
  'settings.markdown.description': 'Controls whether assistant messages render or show raw source',
  'settings.markdown.render': 'Rendered',
  'settings.markdown.raw': 'Raw',
  ...
  'filePreview.binary': 'Binary file, cannot be previewed in the page',
  'filePreview.loading': 'Loading…',
  'filePreview.error': 'Couldn’t read file: {message}',
  'filePreview.loaded': '{loaded} / {total} loaded',
  'filePreview.copy': 'Copy',
  'filePreview.copied': 'Copied',
  'filePreview.jsonLabel': 'JSON content',
  'filePreview.truncated': 'Content too long; showing the first 20000 characters ({total} total)',
  'filePreview.imageFailed': 'Couldn’t load image',
  ...
  'message.rawView': 'Show raw Markdown',
  'message.renderView': 'Show rendered view',
